      ...
      <Row>
        <div className="container_map">
          ...
          <FormGroup>
            ...
            <span id="switch" title="default address"><AppSwitch onChange={this.handleChange} id="address_switch" className={'mx-1'} letiant={'3d'} color={'primary'} checked size={'sm'} /></span>
          </FormGroup>
          <FormGroup>
