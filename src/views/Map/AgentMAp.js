...
let map, pos, panorama, infoWindow;
...
class AgentMap extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    googleScript.src = 'https://maps.googleapis.com/maps/api/js?key=AIzatSyBKHtdFymwut91lTBTQBDgltrFaXPD6TxY2g';
  ...
  initMap() {
    ...
    let latlong = { lat: 6.50954222424663, lng: 3.370920970651687 };
  ...
  addRoute() {
    ...
    if (pos === undefined) {
      start = { lat: 6.60157422424999, lng: 3.360932070651222 };
    } else {
      start = pos;
    }
    let end = { lat: 6.60157222424999, lng: 3.360920570651222 };
